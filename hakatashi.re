...
「異世界」の文明水準は総じて低く、奴隷制度・石造建築・封建制度といった中世風の設定が多く見られます。
...
場合によっては話の重要なファクターを握りうる、非常に重大な要素です。
かの有名なアーサー・C・クラークの言葉、
...
少しややこしいですが、ループや条件分岐など、現代のプログラミング言語に備えられている機能を有していればこの条件は満たします。
...
いずれにせよ異世界というのはこういったあべこべな世界観が入り混じってできたキメラであり、
...
この「鍛造スキル」を用いてオイルライターを製造することが重要イベントとなっているのですが@<fn>{konosuba-bunko}、
肝心のその製造過程を見てみると……。
...
歯車やパレットのような精密部品の鋳造に必要な冶金術が整っていなかった時代のものです。
...
還元され鉄鉱石から鉄となった炉材を浸炭させ、炭素を4%ほど含む@<kw>{銑鉄}へと反応させます@<bib>{tanaka}。

元来、鉄というものは、含有する炭素の量によって性質が大きく変わる金属です。
炭素を全く含まない@<kw>{純鉄}は、融点が1500度と非常に高く、通常の製鉄では得られません。
炭素を添加することによって融点は下がり、飽和状態になる@<kw>{鋳鉄}では1200度程度となります。
...
特にジェームズ・ワットが発明した分離凝縮器を付けた蒸気機関（以後分離凝縮器機関と書く）とクランクの功績はめざましく、
