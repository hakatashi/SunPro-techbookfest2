...
この記事で扱う「コンピューター」とは⋯⋯
 ...
 5. （現実的な範囲内において）チューリングマシンと同等な計算能力を持つこと
...
最後に、「チューリングマシンと同等な計算能力を持つこと」という条件を置きました。
これが、もっとも解釈の難しい条件です。
「チューリングマシンと同等な計算能力」、即ち@<kw>{チューリング完全}とは計算能力の指標の一つであり、
今ではコンピューターの定義とされることも多い概念ですが、
厳密にチューリング完全の条件を満たすマシンはこの世に存在しません。
これはチューリングマシンの条件を満たすには無限の記憶が必要になるからですが、
ここでは一般的に行われているように、「現実的な範囲内で」チューリング完全なものをそう呼ぼうと思います。
