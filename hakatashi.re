...
名前の通り高さのある炉に鉄鉱石と炭を交互に投入し、炉の下部からこれを熱します。
この際、水車などの動力を用いて大量の空気を送風することによって、炉の温度を高めるとともに、
還元された鉄となった炉材を浸炭させ、炭素を4%ほど含む銑鉄へと反応させます@<bib>{tanaka}。
...
鋳鉄は炭素を大量に含むため硬く脆く、大規模な構造物の材料には向きませんが、
融点が低く接合性が高いことから、複雑な形状を鋳るのには最適です。

=== 高炉の動力

現代の高炉がそうであるように、高炉の動力は、高い送風力が得られる燃料装置によるものが望ましいです。
今回の挑戦では蒸気機関が最もそれに近いのですが……蒸気機関を製造するのには高炉から生まれる鋳鉄が必要不可欠なので、
...
そのような旧型の下がけ水車よりも、堰から生まれる水圧によって高速で噴射される水の運動エネルギーを利用するほうが効率がよいことが知られています。
もっとも、高炉にそこまでのパワーは必要としないので、治水のよい異世界ならば適当な河川に建造することも可能です。
