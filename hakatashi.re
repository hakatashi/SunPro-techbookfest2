...
これは、発明書の名前を取って@<kw>{グラム発電機}と呼ばれています。
...
そして重要な特徴として、ON状態のレッドストーンに接続すると、火が消えます。
トーチを経由してレッドストーンを接続することで、ONとOFFを逆転させる回路（論理回路でいうNOT回路）を組むことができます。

なんと、レッドストーンの持つ機能はこれだけです。
論理回路の知識を持った方ならすぐにピンときたでしょうが、
NOT素子とOR素子があればNAND素子を構成することができるため、
それを使って他のあらゆる回路を組み立てることができてしまいます。
