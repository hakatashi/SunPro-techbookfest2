...
異世界でゼロから蒸気機関を作ろうと思ったならば、ワットの分離凝縮機機関あたりが手頃で熱効率もよいでしょう。
ニューコメンが発明した、実用上広く用いられた初めての蒸気機関は、またの名を@<kw>{大気圧機関}と呼びます。
...
非常に素朴でまっとうな機構ですが、ワットは非常に単純なアイデアでこれを大幅に進化させました。
ワットが発明したとされる分離凝縮器機関は、

== 異世界と発電機

蒸気機関の発明から半世紀後、産業革命真っ只中のイギリスに、チャールズ・バベッジという数学科がいました
