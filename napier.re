...
杉原(2013)にて既に示されている通り[1]、「不連続のトリック」や「曲面のトリック」よりは新しい手法ではあるものの
少なくとも4年前には実現されてしまっていたのです。ただ同論文で述べられているように、
「通常の材料(板材や角材)を使った通常の加工法では、作るのが難しい」(前掲書, pp.145)のは事実なので、
3Dプリントによって不可能立体の実現が容易になったことをこうして明らかにしたところに本記事の意義を見出すとしましょう。

今回私が作ったものは立体錯視と呼ばれるものの一つですが、杉原(2016)によれば「新しい立体錯視が次々と発見されている」
ようであり[2]、今後はより新しい形の立体錯視の実現に取り組んでいこうと思っています。
